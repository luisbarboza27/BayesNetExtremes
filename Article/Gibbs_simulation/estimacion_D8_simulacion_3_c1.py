...
nombre_modelo='parametros_D8_simulacion_extremo_V13'+'2_15'
...
print(df_result)
df_result.to_csv('estimacion_r_simulacion_D8_extremo_V3_V13_c1.csv')
df_simul.to_csv('estimacion_t_simulacion_D8_extremo_V3_V13_c1.csv')
