...
def gibbs(n_iter,nombres_parametros,n_covariables,parametros_input,nsites,m,simulacion_proceso,cov,valid_sim_data_1,trainer_covariables,amortizer_covariables,valid_sim_data_raw_D8,trainer_parametros,amortizer_parametros):
    resultados_cov = []
    p1_pred = []
    p2_pred = []
    beta3_pred = []
    ...
    for k in range(n_iter):
        ...
        valid_sim_data_raw_D8['sim_data']=np.expand_dims(input_red_2, axis=0)
        valid_sim_data_raw_D8_c = trainer_parametros.configurator(valid_sim_data_raw_D8)
        # Cambio
        p1,p2,posterior_beta3,posterior_rho= amortizer_parametros.sample(valid_sim_data_raw_D8_c, n_samples=1)[0]
...
parametros_D8= [ r"$\phi$", r"$\sigma$",r"$\beta_3$", r"$\rho$"]
prior_D8 = Prior(prior_fun=model_prior_D8, param_names=parametros_D8)
...
nombre_modelo = 'parametros_D8_1cb'
from tensorflow.keras.layers import ConvLSTM2D, BatchNormalization, Conv2D, MaxPooling2D, TimeDistributed, Flatten, Dense
...
inference_net_D8 = InvertibleNetwork(num_params=len(parametros_D8),num_coupling_layers=10, coupling_settings=COUPLING_NET_SETTINGS,   coupling_design = 'spline')
...
nombre_modelo='covariables_D8_aplicacion_M7'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D8',cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo)
...
trace=gibbs(n_posteriores,nombres_parametros,7,parametros_input,nsites,m,simulacion_proceso,cov,valid_sim_data_1,trainer_covariables,amortizer_covariables,valid_sim_data_raw_D8,trainer_D8,amortizer_D8)
trace.to_csv('trace_'+nombre_modelo+'.csv')
##############################################################
covariable_quitar=6
cov = cov_original[:,0:covariable_quitar]
parametros=parametros[0:covariable_quitar]
nombre_modelo='covariables_D8_aplicacion_M6'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D8',cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo)

trace=gibbs(n_posteriores,nombres_parametros,covariable_quitar,parametros_input,nsites,m,simulacion_proceso,cov,valid_sim_data_1,trainer_covariables,amortizer_covariables,valid_sim_data_raw_D8,trainer_D8,amortizer_D8)
trace.to_csv('trace_'+nombre_modelo+'.csv')
##############################################################
covariable_quitar=5
cov = cov_original[:,0:covariable_quitar]
parametros=parametros[0:covariable_quitar]
nombre_modelo='covariables_D8_aplicacion_M5'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D8',cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo)
...
cov = cov_original[:,0:covariable_quitar]
parametros=parametros[0:covariable_quitar]
nombre_modelo='covariables_D8_aplicacion_M4'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D8',cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo)
...
cov = cov_original[:,0:covariable_quitar]
parametros=parametros[0:covariable_quitar]
nombre_modelo='covariables_D8_aplicacion_M3'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D8',cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo)
...
cov = cov_original[:,0:covariable_quitar]
parametros=parametros[0:covariable_quitar]
nombre_modelo='covariables_D8_aplicacion_M2'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D8',cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo)
...
cov = cov_original[:,0:covariable_quitar]
parametros=parametros[0:covariable_quitar]
nombre_modelo='covariables_D8_aplicacion_M1'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D8',cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo)
