...
def proceso_D8(params, m):
    ...
    y_train_beta3_auxiliar =  np.random.uniform(2,high=7.5,size=1)[0] #OJO
...
def funcion_entrenamiento(simul_previa_D8,cov,parametros,n_epochs,n_batch_size,hidden_size, summary_dim,nombre_modelo,n_row):
    ...
    try:
        ...
        fig = diag.plot_recovery(posterior_samples_D8, valid_sim_data_D8["parameters"], param_names=parametros,n_row=n_row)
...
entrenamiento=funcion_entrenamiento(simul_previa_D8,cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo,n_row=3)

###################################################################
covariable_quitar=6
simul_previa_D8=ajuste_df_covariable(simul_previa_D8,cov,covariable_quitar)
cov = cov_original[:,0:covariable_quitar]
parametros=parametros[0:covariable_quitar]
nombre_modelo='covariables_D8_aplicacion_M6'
entrenamiento=funcion_entrenamiento(simul_previa_D8,cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo,n_row=2)
...
entrenamiento=funcion_entrenamiento(simul_previa_D8,cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo,n_row=1)
