...
nombre_modelo = 'parametros_DYab2'
...
try:
    fig = diag.plot_recovery(posterior_samples_DY, valid_sim_data_DY["parameters"], param_names=parametros_DY, xlabel= "Real",ylabel= "Estimado",n_col=2)
...
nombre_modelo = 'parametros_DYcb2'
from tensorflow.keras.layers import ConvLSTM2D, BatchNormalization, Conv2D, MaxPooling2D, TimeDistributed, Flatten, Dense
class CustomLSTM_DY(tf.keras.Model):
    def __init__(self, hidden_size=1000, summary_dim=2000):
        super().__init__()
...
nombre_modelo = 'parametros_DYdb2'
from tensorflow.keras.layers import ConvLSTM2D, BatchNormalization, Conv2D, MaxPooling2D, TimeDistributed, Flatten, Dense
class CustomLSTM_DY(tf.keras.Model):
    def __init__(self, hidden_size=1000, summary_dim=2000):
        super().__init__()
