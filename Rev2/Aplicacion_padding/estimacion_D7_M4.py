...
cov_original = np.column_stack((np.ones(nsites), Z1, Z2, Z3))
...
parametros_covariables = [r"$\gamma_{0}$",r"$\gamma_{{lon}}$",r"$\gamma_{{lat}}$",r"$\gamma_{{alt}}$"]
...
covariable_quitar=4
nombre_modelo='covariables_D7_aplicacion_M4_V2'
