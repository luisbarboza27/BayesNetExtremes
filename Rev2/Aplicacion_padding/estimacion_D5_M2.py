...
######################################################################################################
nombre_modelo='covariables_D5_aplicacion_M2_V2'
...
trace=gibbs(n_posteriores,nombres_parametros,2,parametros_input,nsites,nsite_completados,m,simulacion_proceso,cov,valid_sim_data_1,trainer_covariables,amortizer_covariables,valid_sim_data_raw_parametros,trainer,amortizer)
trace.to_csv('trace_'+nombre_modelo.replace('_V2', '')+'.csv')
##############################################################
