...
def proceso_D8(params, m):
    ...
    for sitio in range(nsites):
        ...
        auxi=X1_auxiliar*X2_auxiliar*X3_auxiliar*covariables_auxiliar#*X1_auxiliar
...
#3
nombre_modelo='covariables_D8_simulacion_extremo_V4'+'2_15'+'_indicadora'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D8',cov,parametros,n_epochs,n_batch_size,1024, 1024,nombre_modelo)
###################################################################
###################################################################
###################################################################
cov = cov_original
...
class CustomLSTM_D8(tf.keras.Model):
    ...
    def call(self, x, **kwargs):
        ...
        return out
#6
nombre_modelo='parametros_D8_simulacion_extremo_V14'+'2_15'+'_indicadora'
...
print(df_result)
#7
df_result.to_csv('estimacion_r_simulacion_D8_extremo_V4_V14_c1_indicadora.csv')
df_simul.to_csv('estimacion_t_simulacion_D8_extremo_V4_V14_c1_indicadora.csv')
