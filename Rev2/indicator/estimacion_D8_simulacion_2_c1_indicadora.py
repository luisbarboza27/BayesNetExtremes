...
#3
nombre_modelo='covariables_D8_simulacion_extremo_V2'+'2_15'+'_indicadora'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D8',cov,parametros,n_epochs,n_batch_size,128, 1024,nombre_modelo)
###################################################################
###################################################################
###################################################################
cov = cov_original
...
class CustomLSTM_D8(tf.keras.Model):
    ...
    def call(self, x, **kwargs):
        ...
        return out
#6
nombre_modelo='parametros_D8_simulacion_extremo_V12'+'2_15'+'_indicadora'
...
print(df_result)
#7
df_result.to_csv('estimacion_r_simulacion_D8_extremo_V2_V12_c1_indicadora.csv')
df_simul.to_csv('estimacion_t_simulacion_D8_extremo_V2_V12_c1_indicadora.csv')
