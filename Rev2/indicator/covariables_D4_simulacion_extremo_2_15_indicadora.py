...
def funcion_entrenamiento(simul_previa_D4,cov,parametros,n_epochs,n_batch_size,hidden_size, summary_dim,nombre_modelo):
    ...
    try:
        ...
        history_D4 = trainer_D4.train_offline(simulations_dict=simul_previa_D4,epochs=n_epochs,batch_size=n_batch_size,early_stopping=True,validation_sims=128, xlabel= "Real",ylabel= "Estimado",n_col=2)
        myobj2= datetime.now()
        print(myobj2)
        ...
        fig = diag.plot_recovery(posterior_samples_D4, valid_sim_data_D4["parameters"], param_names=parametros)
...
###################################################################
nombre_modelo='covariables_D4_simulacion_extremo_V1'
entrenamiento=funcion_entrenamiento(simul_previa_D4,cov,parametros,n_epochs,n_batch_size,128, 128,nombre_modelo)



###################################################################
nombre_modelo='covariables_D4_simulacion_extremo_V2'
entrenamiento=funcion_entrenamiento(simul_previa_D4,cov,parametros,n_epochs,n_batch_size,128, 1024,nombre_modelo)


###################################################################
nombre_modelo='covariables_D4_simulacion_extremo_V3'
entrenamiento=funcion_entrenamiento(simul_previa_D4,cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo)

###################################################################
nombre_modelo='covariables_D4_simulacion_extremo_V4'
entrenamiento=funcion_entrenamiento(simul_previa_D4,cov,parametros,n_epochs,n_batch_size,1024, 1024,nombre_modelo)


###################################################################
nombre_modelo='covariables_D4_simulacion_extremo_V6'
entrenamiento=funcion_entrenamiento(simul_previa_D4,cov,parametros,n_epochs,n_batch_size,1000, 2000,nombre_modelo)
