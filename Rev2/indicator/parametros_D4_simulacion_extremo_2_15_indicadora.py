...
def funcion_entrenamiento(simul_previa_D4,cov,parametros,n_epochs,n_batch_size,summary_net_D4,nombre_modelo):
    ...
    try:
        ...
        fig = diag.plot_recovery(posterior_samples_D4, valid_sim_data_D4["parameters"], param_names=parametros, xlabel= "Real",ylabel= "Estimado",n_col=4)
    ...
    print('#######################################################################')
    print('Duración (minutos):', tiempo_minutos)
...
###################################################################
nombre_modelo='parametros_D4_simulacion_extremo_V11'
summary_net_D4 = CustomLSTM_D4(128, 128)
entrenamiento=funcion_entrenamiento(simul_previa_D4,cov,parametros,n_epochs,n_batch_size,summary_net_D4,nombre_modelo)

###################################################################
nombre_modelo='parametros_D4_simulacion_extremo_V12'
summary_net_D4 = CustomLSTM_D4(128, 1024)
entrenamiento=funcion_entrenamiento(simul_previa_D4,cov,parametros,n_epochs,n_batch_size,summary_net_D4,nombre_modelo)


###################################################################
nombre_modelo='parametros_D4_simulacion_extremo_V13'
summary_net_D4 = CustomLSTM_D4(1024, 128)
entrenamiento=funcion_entrenamiento(simul_previa_D4,cov,parametros,n_epochs,n_batch_size,summary_net_D4,nombre_modelo)


###################################################################
nombre_modelo='parametros_D4_simulacion_extremo_V14'
summary_net_D4 = CustomLSTM_D4(1024, 1024)
entrenamiento=funcion_entrenamiento(simul_previa_D4,cov,parametros,n_epochs,n_batch_size,summary_net_D4,nombre_modelo)


###################################################################
nombre_modelo='parametros_D4_simulacion_extremo_V15'
summary_net_D4 = CustomLSTM_D4(2048, 128)
entrenamiento=funcion_entrenamiento(simul_previa_D4,cov,parametros,n_epochs,n_batch_size,summary_net_D4,nombre_modelo)


###################################################################
nombre_modelo='parametros_D4_simulacion_extremo_V16'
