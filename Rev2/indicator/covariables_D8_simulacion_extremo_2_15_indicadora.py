...
myobj2= datetime.now()
print(myobj2)
tiempo_minutos = (myobj2 - myobj1).total_seconds() / 6
print('Tiempo de simulacion en minutos: ', tiempo_minutos)
...
def funcion_entrenamiento(simul_previa_D8,cov,parametros,n_epochs,n_batch_size,hidden_size, summary_dim,nombre_modelo):
    nombre_modelo = nombre_modelo+'2_15'+'_indicadora'
    ...
    try:
        ...
        history_D8 = trainer_D8.train_offline(simulations_dict=simul_previa_D8,epochs=n_epochs,batch_size=n_batch_size,early_stopping=True,validation_sims=128, xlabel= "Real",ylabel= "Estimado",n_col=2)
        myobj2= datetime.now()
        print(myobj2)
        tiempo_minutos = (myobj2 - myobj1).total_seconds() / 60
        print('Tiempo de entrenamiento en minutos: ', tiempo_minutos)
        ...
        fig = diag.plot_recovery(posterior_samples_D8, valid_sim_data_D8["parameters"], param_names=parametros)
...
###################################################################
nombre_modelo='covariables_D8_simulacion_extremo_V1'
entrenamiento=funcion_entrenamiento(simul_previa_D8,cov,parametros,n_epochs,n_batch_size,128, 128,nombre_modelo)



###################################################################
nombre_modelo='covariables_D8_simulacion_extremo_V2'
entrenamiento=funcion_entrenamiento(simul_previa_D8,cov,parametros,n_epochs,n_batch_size,128, 1024,nombre_modelo)


###################################################################
nombre_modelo='covariables_D8_simulacion_extremo_V3'
entrenamiento=funcion_entrenamiento(simul_previa_D8,cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo)

###################################################################
nombre_modelo='covariables_D8_simulacion_extremo_V4'
entrenamiento=funcion_entrenamiento(simul_previa_D8,cov,parametros,n_epochs,n_batch_size,1024, 1024,nombre_modelo)


###################################################################
nombre_modelo='covariables_D8_simulacion_extremo_V6'
entrenamiento=funcion_entrenamiento(simul_previa_D8,cov,parametros,n_epochs,n_batch_size,1000, 2000,nombre_modelo)
