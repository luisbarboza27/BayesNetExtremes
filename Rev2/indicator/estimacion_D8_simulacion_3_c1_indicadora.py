...
#3
nombre_modelo='covariables_D8_simulacion_extremo_V3'+'2_15'+'_indicadora'
...
class CustomLSTM_D8(tf.keras.Model):
    ...
    def call(self, x, **kwargs):
        ...
        return out
#6
nombre_modelo='parametros_D8_simulacion_extremo_V13'+'2_15'+'_indicadora'
...
print(df_result)
#7
df_result.to_csv('estimacion_r_simulacion_D8_extremo_V3_V13_c1_indicadora.csv')
df_simul.to_csv('estimacion_t_simulacion_D8_extremo_V3_V13_c1_indicadora.csv')
