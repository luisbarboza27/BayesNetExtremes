...
nombre_modelo='covariables_D4_simulacion_extremo_V6'+'2_15'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D4',cov,parametros,n_epochs,n_batch_size,1000, 2000,nombre_modelo)
###################################################################
###################################################################
###################################################################
cov = cov_original
...
def proceso_D4(params, m):
    ...
    X3_auxiliar_completo = simular_X3(
        m,
        y_train_rho_auxiliar,
    ...
    for tiempo in range(m):
        # Matrix 10x10
        matriz10 = X_train_auxiliar[0][tiempo, :].reshape(10, 10)

        # Padding with zeros to create a 13x13 matrix
        matriz13 = np.pad(
            matriz10,
            pad_width=((1, 2), (1, 2)),
            mode='constant',
        ...
        X_train_auxiliar_para_convolucion.append(
            matriz13.reshape(13, 13, 1).tolist()
        )
...
nombre_modelo='parametros_D4_simulacion_extremo_V16'+'2_15_pad_13x13'
summary_net_D4 = CustomLSTM_D4(1000, 2000)
...
print(df_result)
df_result.to_csv('estimacion_r_simulacion_D4_extremo_V6_V16_c1_pad_13x13.csv')
df_simul.to_csv('estimacion_t_simulacion_D4_extremo_V6_V16_c1_pad_13x13.csv')
