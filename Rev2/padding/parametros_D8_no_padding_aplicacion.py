...
nsites=nsite_completados



Z1 = loc_all_completar['lon'] 
Z2 = loc_all_completar['lat']   
...
dist_mat = squareform(pdist(loc_all_completar))  
cov = np.column_stack((np.ones(nsites), Z1, Z2, Z3))
rho_upper_range = 2*np.max(squareform(pdist(loc_all_completar)))
m=200

print(str(nsites) + ' locations')
print(str(m) + ' in time')
loc_all_completar['aux']=1
...
modelos = {
    'parametros_D8_1_no_padding_sim_apli': (128,128),
    'parametros_D8_2_no_padding_sim_apli': (128,1024),
    'parametros_D8_3_no_padding_sim_apli': (1024,128),
    'parametros_D8_4_no_padding_sim_apli': (1024,1024),
    'parametros_D8_6_no_padding_sim_apli': (1000,2000)
}
