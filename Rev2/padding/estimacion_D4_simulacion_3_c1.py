...
nombre_modelo='covariables_D4_simulacion_extremo_V3'+'2_15'
...
class CustomLSTM_D4(tf.keras.Model):
    def __init__(self, hidden_size=1000, summary_dim=2000):
        ...
        timesteps = m
        self.LSTM = tf.keras.Sequential(
            [   tf.keras.layers.Input((timesteps,13, 13, 1)), # CAMBIO
...
nombre_modelo='parametros_D4_simulacion_extremo_V13'+'2_15_pad_13x13'
...
print(df_result)
df_result.to_csv('estimacion_r_simulacion_D4_extremo_V3_V13_c1_pad_13x13.csv')
df_simul.to_csv('estimacion_t_simulacion_D4_extremo_V3_V13_c1_pad_13x13.csv')
