...
def proceso_D8(params, m):
    ...
    for sitio in range(nsites):
        ...
        X3_auxiliar = X3_auxiliar_completo[:, sitio]
        auxi = np.log(X1_auxiliar*X2_auxiliar * X3_auxiliar)
        cuantil_75 = np.quantile(auxi, 0.75)
        X_train_auxiliar[sitio] = np.where(auxi < cuantil_75, cuantil_75, auxi)
...
nombre_modelo='parametros_D8_simulacion_extremo_V11'+'2_15_pad_13x13'
...
print(df_result)
df_result.to_csv('estimacion_r_simulacion_D8_extremo_V1_V11_c1_pad_13x13.csv')
df_simul.to_csv('estimacion_t_simulacion_D8_extremo_V1_V11_c1_pad_13x13.csv')
