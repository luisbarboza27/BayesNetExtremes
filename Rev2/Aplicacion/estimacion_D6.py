...
def gibbs(n_iter,nombres_parametros,n_covariables,parametros_input,nsites,nsites_completados,m,simulacion_proceso,cov,valid_sim_data_1,trainer_covariables,amortizer_covariables,valid_sim_data_raw_DY,trainer_parametros,amortizer_parametros):
    print('###################################')
    print('Inicia Gibbs...')
    print('###################################')
    resultados_cov = []
...
model_name = 'parametros_D6_3'
summary_net_parametros = CustomLSTM(1024,128)
inference_net_parametros = InvertibleNetwork(
    num_params=4,
    num_coupling_layers=10,
    coupling_settings=COUPLING_NET_SETTINGS,
    coupling_design='spline'
)
amortizer_parametros = AmortizedPosterior(
    inference_net_parametros,
    summary_net_parametros,
    name=model_name
)
trainer_parametros = Trainer(
    amortizer=amortizer_parametros,
...
def funcion_prediccion_covariables(simul_previa_DY,cov,parametros,n_epochs,n_batch_size,hidden_size, summary_dim,nombre_modelo):
    ...
    inference_net = InvertibleNetwork(num_params=cov.shape[1], num_coupling_layers=4, coupling_settings=COUPLING_NET_SETTINGS)
...
######################################################################################################
nombre_modelo='covariables_D6_aplicacion_M7'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D6',cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo)
trace=gibbs(n_posteriores,nombres_parametros,7,parametros_input,nsites,nsite_completados,m,simulacion_proceso,cov,valid_sim_data_1,trainer_covariables,amortizer_covariables,valid_sim_data_raw_parametros,trainer_parametros,amortizer_parametros)
...
nombre_modelo='covariables_D6_aplicacion_M6'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D6',cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo)

trace=gibbs(n_posteriores,nombres_parametros,covariable_quitar,parametros_input,nsites,nsite_completados,m,simulacion_proceso,cov,valid_sim_data_1,trainer_covariables,amortizer_covariables,valid_sim_data_raw_parametros,trainer_parametros,amortizer_parametros)
trace.to_csv('trace_'+nombre_modelo+'.csv')
##############################################################
covariable_quitar=5
cov = cov_original[:,0:covariable_quitar]
parametros=parametros[0:covariable_quitar]
nombre_modelo='covariables_D6_aplicacion_M5'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D6',cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo)
...
cov = cov_original[:,0:covariable_quitar]
parametros=parametros[0:covariable_quitar]
nombre_modelo='covariables_D6_aplicacion_M4'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D6',cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo)
...
cov = cov_original[:,0:covariable_quitar]
parametros=parametros[0:covariable_quitar]
nombre_modelo='covariables_D6_aplicacion_M3'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D6',cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo)
...
cov = cov_original[:,0:covariable_quitar]
parametros=parametros[0:covariable_quitar]
nombre_modelo='covariables_D6_aplicacion_M2'
amortizer_covariables,trainer_covariables,valid_sim_data_1=funcion_prediccion_covariables('simul_previa_D6',cov,parametros,n_epochs,n_batch_size,1024, 128,nombre_modelo)
