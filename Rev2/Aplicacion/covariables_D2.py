...
def entrenar_multiples_modelos_covariables(modelos_config, cov_original, parametros_originales, total_sims=n_iterations_per_epoch * n_batch_size):
    ...
    for i in range(0, total_sims, block_size):
        ...
        for nombre_modelo, cfg in modelos_config.items():
            ...
            while cov_actual.shape[1] > num_covs:
                ...
                parametros_actuales = parametros_actuales[0:(covariable_quitar+2)]
    ...
    for nombre_modelo, cfg in modelos_config.items():
        ...
        while valid_cov.shape[1] > num_covs:
            ...
            valid_parametros = valid_parametros[0:(covariable_quitar+2)]
...
configuracion_modelos = {
    ...
    'covariables_D2_aplicacion_M6': {'num_covs': 6, 'hidden_size': 1024, 'summary_dim': 128, 'n_row': 3},
    'covariables_D2_aplicacion_M5': {'num_covs': 5, 'hidden_size': 1024, 'summary_dim': 128, 'n_row': 3},
    'covariables_D2_aplicacion_M4': {'num_covs': 4, 'hidden_size': 1024, 'summary_dim': 128, 'n_row': 2},
    'covariables_D2_aplicacion_M3': {'num_covs': 3, 'hidden_size': 1024, 'summary_dim': 128, 'n_row': 2},
    'covariables_D2_aplicacion_M2': {'num_covs': 2, 'hidden_size': 1024, 'summary_dim': 128, 'n_row': 2},
    'covariables_D2_aplicacion_M1': {'num_covs': 1, 'hidden_size': 1024, 'summary_dim': 128, 'n_row': 1},
}
