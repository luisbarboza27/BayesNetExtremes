...
def funcion_entrenamiento(simul_previa_DY,cov,parametros,n_epochs,n_batch_size,hidden_size, summary_dim,nombre_modelo):
    ...
    try:
        history_DY = trainer_DY.train_offline(simulations_dict=simul_previa_DY,epochs=n_epochs,batch_size=n_batch_size,early_stopping=True,validation_sims=128, xlabel= "Real",ylabel= "Estimado",n_col=2)
...
###################################################################
nombre_modelo='covariables_DY_simulacion_extremo_V6'
entrenamiento=funcion_entrenamiento(simul_previa_DY,cov,parametros,n_epochs,n_batch_size,1000, 2000,nombre_modelo)
