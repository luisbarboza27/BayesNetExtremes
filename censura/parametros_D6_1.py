...
parametros_D6= [ r"$\phi$", r"$\sigma$",r"$\beta_3$", r"$\rho$"]
prior_D6 = Prior(prior_fun=model_prior_D6, param_names=parametros_D6)
prior_means_D6, prior_stds_D6 = prior_D6.estimate_means_and_stds()
 

##################


def proceso_D6(params, m):
...
time_points=m
simulator_D6 = Simulator(simulator_fun=partial(proceso_D6, m=time_points))
model_D6 = GenerativeModel(prior_D6, simulator_D6, name="simulador_proceso")
data_D6 = model_D6(batch_size=1)


nombre_modelo = 'parametros_D6_1'
from tensorflow.keras.layers import ConvLSTM2D, BatchNormalization, Conv2D, MaxPooling2D, TimeDistributed, Flatten, Dense
class CustomLSTM_D6(tf.keras.Model):
...
simul_previa_D6 = model_D6(batch_size=n_iterations_per_epoch*n_batch_size)
# try:
...
inference_net_D6 = InvertibleNetwork(num_params=len(parametros_D6),num_coupling_layers=10, coupling_settings=COUPLING_NET_SETTINGS,   coupling_design = 'spline')
amortizer_D6 = AmortizedPosterior(inference_net_D6, summary_net_D6, name=nombre_modelo)
trainer_D6 = Trainer(amortizer=amortizer_D6, generative_model=model_D6, memory=True, checkpoint_path = nombre_modelo)
history_D6 = trainer_D6.train_offline(simulations_dict=simul_previa_D6,epochs=n_epochs,batch_size=n_batch_size,early_stopping=True,validation_sims=128)
valid_sim_data_raw_D6 = model_D6(batch_size=128)
valid_sim_data_D6 = trainer_D6.configurator(valid_sim_data_raw_D6)
posterior_samples_D6 = amortizer_D6.sample(valid_sim_data_D6, n_samples=100)
fig = diag.plot_recovery(posterior_samples_D6, valid_sim_data_D6["parameters"], param_names=parametros_D6)
