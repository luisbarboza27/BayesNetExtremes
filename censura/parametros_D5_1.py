...
parametros_D5= [ r"$\phi$", r"$\sigma$",r"$\beta_3$", r"$\rho$"]
prior_D5 = Prior(prior_fun=model_prior_D5, param_names=parametros_D5)
prior_means_D5, prior_stds_D5 = prior_D5.estimate_means_and_stds()
 

##################


def proceso_D5(params, m):
...
time_points=m
simulator_D5 = Simulator(simulator_fun=partial(proceso_D5, m=time_points))
model_D5 = GenerativeModel(prior_D5, simulator_D5, name="simulador_proceso")
data_D5 = model_D5(batch_size=1)
...
class CustomLSTM_D5(tf.keras.Model):
...
simul_previa_D5 = model_D5(batch_size=n_iterations_per_epoch*n_batch_size)
# try:
...
inference_net_D5 = InvertibleNetwork(num_params=len(parametros_D5) ,num_coupling_layers=10, coupling_settings=COUPLING_NET_SETTINGS,   coupling_design = 'spline')
amortizer_D5 = AmortizedPosterior(inference_net_D5, summary_net_D5, name=nombre_modelo)
trainer_D5 = Trainer(amortizer=amortizer_D5, generative_model=model_D5, memory=True, checkpoint_path = nombre_modelo)
history_D5 = trainer_D5.train_offline(simulations_dict=simul_previa_D5,epochs=n_epochs,batch_size=n_batch_size,early_stopping=True,validation_sims=128)
valid_sim_data_raw_D5 = model_D5(batch_size=128)
valid_sim_data_D5 = trainer_D5.configurator(valid_sim_data_raw_D5)
posterior_samples_D5 = amortizer_D5.sample(valid_sim_data_D5, n_samples=100)
fig = diag.plot_recovery(posterior_samples_D5, valid_sim_data_D5["parameters"], param_names=parametros_D5)
