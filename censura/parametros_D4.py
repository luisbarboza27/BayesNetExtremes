...
inference_net_D4 = InvertibleNetwork(num_params=4 ,num_coupling_layers=10, coupling_settings=COUPLING_NET_SETTINGS,   coupling_design = 'spline')
amortizer_D4 = AmortizedPosterior(inference_net_D4, summary_net_D4, name=nombre_modelo)
trainer_D4 = Trainer(amortizer=amortizer_D4, generative_model=model_D4, memory=True, checkpoint_path = nombre_modelo)
...
valid_sim_data_raw_D4 = model_D4(batch_size=128)
...
fig = diag.plot_recovery(posterior_samples_D4, valid_sim_data_D4["parameters"], param_names=parametros_D4)
print('######################################################################')
