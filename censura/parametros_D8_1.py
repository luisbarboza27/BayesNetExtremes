...
trainer_D8 = Trainer(amortizer=amortizer_D8, generative_model=model_D8, memory=True, checkpoint_path = nombre_modelo)
...
fig = diag.plot_recovery(posterior_samples_D8, valid_sim_data_D8["parameters"], param_names=parametros_D8)
